...
#define LOG_ERROR(fmt, ...)   LOG_BASE("ERROR",   ANSI_COLOR_RED,     stderr, fmt, ##__VA_ARGS__)
#define LOG_MSG_ERROR(fmt, ...) LOG_BASE("MSG ERROR", ANSI_COLOR_MAGENTA, stderr, fmt, ##__VA_ARGS__)
...
#define LOG_ERROR_TAG(fmt, ...)   LOG_BASE_TAG("ERROR",   ANSI_COLOR_RED,     stderr, LOG_TAG, fmt, ##__VA_ARGS__)
#define LOG_MSG_ERROR_TAG(fmt, ...) LOG_BASE_TAG("MSG ERROR", ANSI_COLOR_MAGENTA, stderr, LOG_TAG, fmt, ##__VA_ARGS__)
...
#define LOG_DEBUG_ERROR(fmt, ...) \
    LOG_BASE("ERROR", ANSI_COLOR_RED, stderr, "%s:%d " fmt, __FILE__, __LINE__, ##__VA_ARGS__)
